<?php get_header(); ?>
    ...
    <main>
        <!-- TODO section じゃない？ -->
        <!-- TODO 部品は div 段落的な意味合いには section を 意識しよう -->
        <div class="newinfo">
            <h1>更新情報</h1>
            <div class="info_slot">
                <!--a href=""-->
                <!-- TODO sou "P"が大文字 -->
                <!-- TODO sou なるべく br タグを使わない  -->
                <!-- TODO sou デザイン上改行は致し方ないので、中央揃えはやめたほうがいいんじゃない？ -->
                <!-- TODO sou この辺りのスロットの高さは揃えたい -->
                <!-- TODO sou 無駄な余白が多すぎない？ -->
                <!-- TODO sou イメージこんな感じ -->
                <!--
                <div class="info_slot">
                    <h3>2016.10.1(土)</h3>
            ...
            <!-- TODO 空の div は HTML の文法上良くないので after擬似要素を用いたクリアフィックスを使う -->
            <div class="clearfix"></div>
        </div>
        ...
        <div class="event_info">
            ...
            <div class="event_slot">
                <a href="">
                    <img clas="event_img" src="<?php echo get_template_directory_uri(); ?>/img/event_img1.jpg"
                         alt="イメージ1">
                </a>
            </div>
            <div class="event_slot">
                <a href="">
                    <img clas="event_img" src="<?php echo get_template_directory_uri(); ?>/img/event_img2.jpg"
                         alt="イメージ2">
                </a>
            </div>
            <div class="event_slot">
                <a href="">
                    <img clas="event_img" src="<?php echo get_template_directory_uri(); ?>/img/event_img3.jpg"
                         alt="イメージ3">
                </a>
            </div>
            <div class="event_slot">
                <a href="">
                    <img clas="event_img" src="<?php echo get_template_directory_uri(); ?>/img/event_img4.jpg"
                         alt="イメージ4">
                </a>
            </div>
        </div>
        ...
        <!-- TODO 空の div は HTML の文法上良くないので after擬似要素を用いたクリアフィックスを使う -->
        <!-- TODO 企画紹介のボタンなので event_info の中に入れるべきじゃない？ -->
        <div class="clearfix"></div>
        <div id="top_more_button" class="more_button">
        ...
        <!-- TODO facebookをいれない理由は？ -->
        <!-- TODO 入れるなら section > (div.top_twitter+div.top_facebook) -->
